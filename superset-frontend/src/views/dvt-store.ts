...
import dvtHomeReducer from 'src/dvt-redux/dvt-homeReducer';
...
import dvtRowlevelsecurityReducer from 'src/dvt-redux/dvt-rowlevelsecurityReducer';
import dvtDashboardEditReducer from 'src/dvt-redux/dvt-dashboardEditReducer';
...
const reducers = {
  ...
  dvtHome: dvtHomeReducer,
  dvtConnection: dvtConnectionReducer,
  dvtChart: dvtChartReducer,
  dvtSqlhub: dvtSqlhubReducer,
  dvtAlert: dvtAlertReducer,
  dvtRowLevelSecurity: dvtRowlevelsecurityReducer,
  dvtDashboardEdit: dvtDashboardEditReducer,
};

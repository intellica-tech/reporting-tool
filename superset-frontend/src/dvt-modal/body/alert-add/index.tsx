...
const DvtAlertAdd = ({ meta, onClose }: ModalProps) => {
  ...
  const ChartTypeOnChange = (e: RadioChangeEvent) => {
    setChartType(e.target.value);
  };

  const timeScheduleOnChange = (e: RadioChangeEvent) => {
      ...
      <StyledAlertAddBody>
        ...
        <StyledAlertAddItemGroup>
          ...
          <StyledAlertAddAlertConditionSchedule>
            ...
            <Radio.Group onChange={timeScheduleOnChange} value={timeSchedule}>
          ...
          <StyledAlertAddMessageContent>
            ...
            />
            {value === 'Chart' && (
              <Radio.Group onChange={ChartTypeOnChange} value={chartType}>
                <Radio value="PNG">Send as PNG</Radio>
                <Radio value="SVG">Send as SVG</Radio>
              </Radio.Group>
            )}
            {value === 'Dashboard' && (
              <DvtCheckbox

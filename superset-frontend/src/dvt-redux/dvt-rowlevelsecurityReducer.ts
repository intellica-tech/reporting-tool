...
interface DvtAppState {
  rowLevelSecurityAddStatus: string;
}
...
const dvtRowLevelSecuritySlice = createSlice({
  name: 'dvt-rowlevelsecurity',
  initialState,
  reducers: {
    dvtRowLevelSecurityAddStatus: (state, action: PayloadAction<string>) => ({
      ...state,
      rowLevelSecurityAddStatus: action.payload,
    }),
  },
});

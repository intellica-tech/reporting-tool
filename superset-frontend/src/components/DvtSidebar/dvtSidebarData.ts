    ...
    data: [
      {
        ...
        label: t('CATEGORY'),
        values: [
          { value: 'timeSeries', label: t('Time Series') },
          { value: 'statistical', label: t('Statistical') },
          { value: 'segmentation', label: t('Segmentation') },
        ],
      },
      {
